...
Here are full text-based example reports generated by the AI Investment Research Agent, showcasing the exact structural formatting, detailed financial health metrics, risk assessments, and rationale lists that the agent parses:

### 🟢 Example 1: Apple Inc. (INVEST Verdict)
````markdown
...
### 🔴 Example 2: Tesla Inc. (PASS Verdict)
````markdown
